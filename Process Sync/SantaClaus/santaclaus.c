 ...
 * Para permitir que Santa descanse lo mejor posible, los elfos solo pueden despertarlo cuando tres de ellos
 * tienen problemas.
 * Cuando estos tres elfos están resolviendo sus problemas, cualquier otro elfo que quiera visitar a Santa debe
 * esperar a que estos elfos terminen.
 * En el momento que el último reno arriba al Polo Norte, este debe ir a buscar a Santa mientras los demás esperan
 * en una cálida cabaña antes de ser enganchados al trineo.
 * Si Santa se despierta y encuentra a tres elfos esperando en la puerta de su tienda, junto con el último reno
 * que ha regresado de los trópicos, atiende primero a los renos, ya que es más importante preparar su trineo.
 *
